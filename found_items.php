...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($category != "All") {
        ...
        where Item.Status='Unresolved' and Item.Category='$category' and Item.Type='Found';
        ";
    } else {
        $sql = "
        select Item.*, User.Email 
        ...
        join User 
        on Item.User_id = User.User_id 
        where Item.Status='Unresolved' and Item.Type='Found';
        ";
    }
} else {
    $sql = "
...
<body>
    <h1 class="display-2 text-center mb-4">The Found</h1>
            ...
            <div class="d-flex justify-content-evenly text-center text-break">
                ...
                <div class="w-75 d-flex flex-column">
                    <div class="d-flex justify-content-evenly w-100">
                        <div class="w-100">
                            <b class="text-decoration-underline">Location Found</b><br>
                        ...
                        <div class="w-100">
                            <b class="text-decoration-underline">Date Found</b><br>
